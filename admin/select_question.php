...
?>
	...
	<div class="wrapper">
		<div class="row">
			<div class="col-sm-12">
				<section class="panel">
					...
					<div class="adv-table editable-table"><a class='btn btn-primary btn-sm shiny' href='insertquestion.php'><i class="fa fa-plus"  >录入选择题</i></a></div>
        ...
        foreach ($questions as $row) {
            ...
            echo "<td><a  href='" . $url . "'>编辑</a></td>";
            echo "<td><a  href='" . $delurl . "'>删除</a></td>";
